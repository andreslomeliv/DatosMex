...
class Banxico:
    ...
    def obtener_series(self, 
        ...
        Parametros
        -----------
        indicadores: str/list. Calve(s) de los indicadores a consultar. Puede ser hasta un máximo de 20 indicadores a la vez. Las claves de los indicadores se pueden enviar individualmente, como una lista o en un rango (ej. "SF1-SF5").
