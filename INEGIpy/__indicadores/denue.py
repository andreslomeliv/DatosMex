...
class DENUE:
    ...
    def Buscar(self, condiciones, latitud, longitud, distancia, as_geodf = True):
        ...
        Regresa un DataFrame o GeoDataFrame con la información de la consulta o None en caso de no encontrar resultados.
    ...
    def Cuantificar(self, clave_actividad = '0', clave_area = '0', estrato = '0'):
        ...
        Regresa un DataFrame con la información de la consulta o None en caso de no encontrar resultados.
